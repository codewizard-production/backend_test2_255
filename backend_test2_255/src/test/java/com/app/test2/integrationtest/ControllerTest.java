...
class ControllerTest {
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM test2.FundingRound");
    jdbcTemplate.execute("DELETE FROM test2.Stage");
    jdbcTemplate.execute("DELETE FROM test2.Document");
    jdbcTemplate.execute("DELETE FROM test2.Investor");
    jdbcTemplate.execute("DELETE FROM test2.Founder");
    jdbcTemplate.execute("DELETE FROM test2.Startup");
     jdbcTemplate.execute("DELETE FROM test2.StartupFounders");
     jdbcTemplate.execute("DELETE FROM test2.StartupKeyMetrics");
     jdbcTemplate.execute("DELETE FROM test2.InvestorInvestmentPreferences");
     jdbcTemplate.execute("DELETE FROM test2.StartupPreviousRounds");
     jdbcTemplate.execute("DELETE FROM test2.FundingRoundInvestors");
