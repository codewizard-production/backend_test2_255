...
@Entity(name = "Startup")
@Table(name = "\"Startup\"", schema =  "\"test2\"")
@Data
...
@Column(name = "\"KeyMetrics\"")
    ...
    @CollectionTable(schema = "\"test2\"", name = "\"StartupKeyMetrics\"",joinColumns = @JoinColumn(name = "\"SId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"FId\""), schema = "\"test2\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"SId\""),
            inverseJoinColumns = @JoinColumn( name="\"RoundId\""), schema = "\"test2\"")
